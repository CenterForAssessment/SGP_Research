...
```{r, echo=FALSE, include=FALSE}
   ...
   p <- p + scale_y_continuous(name="School Mean SGP Differences")
	...
	ggsave(filename = file.path(params$working.directory, "assets", "img", paste0("Skip_Year_SGP_Comp_SGP_x_", demog.group$label, ".pdf")), plot=p, device = "pdf", width = 7.5, height = 6, units = "in")
```

```{r, results="asis", echo=FALSE}
	placeFigure(
			files = paste0("./assets/img/Skip_Year_SGP_Comp_SGP_x_", demog.group$label, ".pdf"),
