...
```{r, results='asis', echo=FALSE, School_Lev_Diff_Approx}
...
```{r, cache=TRUE, echo=FALSE, include=FALSE, Sch_Diff_Plot}
  ...
  ggsave(filename = file.path(params$working.directory, "assets", "img", "Skip_Year_SGP_Comp_Diff_x_N.pdf"), plot=p, device = "pdf", width = 7, height = 5.5, units = "in")
```

```{r, results="asis", echo=FALSE, Sch_Diff_Plot_Place}
		placeFigure(
			files = "./assets/img/Skip_Year_SGP_Comp_Diff_x_N.pdf",
