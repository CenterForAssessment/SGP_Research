...
```{r, results="asis", echo=FALSE}
		placeFigure(
			files = file.path(params$working.directory, "assets", "img", "Skip_Year_SGP_Comp_Diff_x_N.pdf"),
