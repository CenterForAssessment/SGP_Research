...
```{r, results='asis', echo=FALSE}
	demog_corrs <- demog_smry[, 1:7] # Means/SDs/Cors
	demog_corrs$CONTENT_AREA <- sapply(demog_corrs$CONTENT_AREA, capwords, USE.NAMES=FALSE)
	demog_corrs$CONTENT_AREA[duplicated(demog_corrs$CONTENT_AREA)] <- ""
	...
	setnames(demog_corrs, sapply(gsub("_Sequential|_Skip", "", names(demog_corrs)), capwords, special.words=c(demog.group$label, "SGP", "SD")))
