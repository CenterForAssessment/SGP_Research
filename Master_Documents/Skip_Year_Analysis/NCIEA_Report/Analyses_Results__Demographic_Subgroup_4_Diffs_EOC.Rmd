...
```{r, echo=FALSE, include=FALSE}
   ...
   plot.file <- file.path("..", "assets", "img", paste0("Skip_Year_SGP_Comp_SGP_x_", demog.group$label, "_EOC.svg"))
	 ggsave(filename = plot.file, plot=p, device = "svg", width = 7.5, height = 7, units = "in")
```

```{r, fig.cap = markdown::markdownToHTML(text=Gmisc::figCapNo(paste("Mean SGP difference by percent", demog.group$label, "by EOC subject")), fragment.only=TRUE), out.width="100%", fig.align='center', out.extra='data-prefix="Figure"'}
knitr::include_graphics(plot.file)
```
