...
```{r, echo=FALSE, include=FALSE}
  ...
  if (ifelse(!exists("github.download.tf"), FALSE, github.download.tf)) {
    params$child.file.path <- file.path("..", "assets", "rmd", "github_children")
    options("renderMultiDocument_Message" = paste0(
                ...
                "'child.file.path' to '", file.path(".", "assets", "rmd", "github_children"), "' in 'report_params' list or 'params' YAML to avoid file re-download/overwrite.     "))
  }
...
```{r, echo=FALSE, include=FALSE}
  ...
  if (!dir.exists(file.path("..", "assets", "img"))) {
    dir.create(file.path("..", "assets", "img"), showWarnings = FALSE, recursive = TRUE)
  }
