...
```{r, cache=FALSE, results="asis", echo=FALSE}
	...
	for (ca in params$GoF_GL_subjects) {
		...
		doc.seq.plot.place <- file.path("..", "assets", "img", "Goodness_of_Fit", "Sequential", gsub(params$gof.path.seq, "", seq.plot.list, fixed=TRUE))
		...
		doc.skip.plot.place <- file.path("..", "assets", "img", "Goodness_of_Fit", "Skip_Year", gsub(params$gof.path.skip, "", skip.plot.list, fixed=TRUE))
