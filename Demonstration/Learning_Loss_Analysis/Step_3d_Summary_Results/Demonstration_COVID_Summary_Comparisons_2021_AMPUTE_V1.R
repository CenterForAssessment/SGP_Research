...
for (data.iter in names(list_of_data_files_for_summary)) {
    ...
    list_of_summary_files[[data.iter]][,c("MEAN_SCALE_SCORE_COMPLETE", "MEAN_SGP_COMPLETE", "MEAN_SGP_BASELINE_COMPLETE"):=Demonstration_COVID_SGP_Summaries_STEP_3d[,c("MEAN_SCALE_SCORE_COMPLETE", "MEAN_SGP_COMPLETE", "MEAN_SGP_BASELINE_COMPLETE")]]
