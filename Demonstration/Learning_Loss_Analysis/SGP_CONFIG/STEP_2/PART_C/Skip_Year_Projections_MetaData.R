...
SGPstateData[["DEMO_COVID"]][["SGP_Configuration"]][['sgp.projections.max.forward.progression.years']] <- 1
SGPstateData[["DEMO_COVID"]][['SGP_Configuration']][['max.sgp.target.years.forward']] <- 1

###   Set Skip_Year_Projections to TRUE (non-NULL) to allow for skip year
SGPstateData[["DEMO_COVID"]][["SGP_Configuration"]][["Skip_Year_Projections"]] <- TRUE
