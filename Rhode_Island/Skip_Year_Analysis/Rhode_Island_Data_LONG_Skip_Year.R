...
## Adam load("../../../Hawaii/Data/Hawaii_SGP_LONG_Data.Rdata")
load("../../../../Hawaii/master/Data/Hawaii_SGP_LONG_Data.Rdata")
...
###   Rename variables as 'NO_SKIP_SGP' (Official data reported by Hawaii DOE)
