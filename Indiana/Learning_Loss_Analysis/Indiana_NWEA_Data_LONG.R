...
tmp.nwea.WINTER_to_WINTER.data <- tmp.nwea.data[!is.na(WinterToWinterConditionalGrowthPercentile),list(MEAN_WINTER_TO_WINTER_SGP=round(mean(WinterToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), MEDIAN_WINTER_TO_WINTER_SGP=median(as.numeric(WinterToWinterConditionalGrowthPercentile), na.rm=TRUE), COUNT=.N), keyby=c("Subject", "GRADE_ID")]
tmp.nwea.FALL_to_WINTER.data <- tmp.nwea.data[!is.na(FallToWinterConditionalGrowthPercentile),list(MEAN_FALL_TO_WINTER_SGP=round(mean(FallToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), MEDIAN_FALL_TO_WINTER_SGP=median(as.numeric(FallToWinterConditionalGrowthPercentile), na.rm=TRUE), COUNT=.N), keyby=c("Subject", "GRADE_ID")]
...
tmp.nwea.FALL_to_WINTER.data.ethnicity <- tmp.nwea.data[!is.na(FallToWinterConditionalGrowthPercentile),list(MEAN_FALL_TO_WINTER_SGP=round(mean(FallToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject",  "ETHNICITY")]

tmp.nwea.FALL_to_FALL.data.district <- tmp.nwea.data[!is.na(FallToFallConditionalGrowthPercentile),list(MEAN_FALL_TO_FALL_SGP=round(mean(FallToFallConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject", "IDOE_CORPORATION_ID")]
tmp.nwea.WINTER_to_WINTER.data.district <- tmp.nwea.data[!is.na(WinterToWinterConditionalGrowthPercentile),list(MEAN_WINTER_TO_WINTER_SGP=round(mean(WinterToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject",  "IDOE_CORPORATION_ID")]
tmp.nwea.FALL_to_WINTER.data.district <- tmp.nwea.data[!is.na(FallToWinterConditionalGrowthPercentile),list(MEAN_FALL_TO_WINTER_SGP=round(mean(FallToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject",  "IDOE_CORPORATION_ID")]

tmp.nwea.FALL_to_FALL.data.ethnicity.grade <- tmp.nwea.data[!is.na(FallToFallConditionalGrowthPercentile),list(MEAN_FALL_TO_FALL_SGP=round(mean(FallToFallConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject","GRADE_ID", "ETHNICITY")]
tmp.nwea.WINTER_to_WINTER.data.ethnicity.grade <- tmp.nwea.data[!is.na(WinterToWinterConditionalGrowthPercentile),list(MEAN_WINTER_TO_WINTER_SGP=round(mean(WinterToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject", "GRADE_ID", "ETHNICITY")]
tmp.nwea.FALL_to_WINTER.data.ethnicity.grade <- tmp.nwea.data[!is.na(FallToWinterConditionalGrowthPercentile),list(MEAN_FALL_TO_WINTER_SGP=round(mean(FallToWinterConditionalGrowthPercentile, na.rm=TRUE), digits=1), COUNT=.N), keyby=c("Subject", "GRADE_ID", "ETHNICITY")]
